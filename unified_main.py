...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_contrastive_loss', default=True, type=str2bool, help='Use contrastive loss for report-image alignment')
    parser.add_argument('--contrastive_alpha', default=0.1, type=float, help='Weight for contrastive loss')
    parser.add_argument('--contrastive_temperature', default=0.07, type=float, help='Temperature for contrastive loss')
    ...
    if args.use_contrastive_loss:
        ...
        report_projection = nn.Sequential(
            nn.Linear(768, 512), 
            nn.ReLU(),
            nn.Linear(512, 512)
        )
